...
namespace Rcw.Oracle
{
    ...
    public partial class SqlSugarTool
    {
        ...
        /// <returns></returns>
        internal static string GetPrimaryKeyByTableName(SqlRcwClient db, string tableName)
        {
        ...
        /// <param name="tableName"></param>
        /// <returns></returns>
        internal static List<string> GetPrimaryKeyByTableNames(SqlRcwClient db, string tableName)
        {
   ...
   where cu.constraint_name = au.constraint_name
    and au.constraint_type = 'P' and au.table_name = '" + tableName.GetTranslationSqlName() + @"'";
        ...
        /// <param name="tableName"></param>
        /// <returns></returns>
        internal static List<KeyValue> GetIdentitiesKeyByTableName(SqlRcwClient db, string tableName)
        {
        ...
        /// <param name="tableName"></param>
        /// <returns></returns>
        internal static List<string> GetColumnsByTableName(SqlRcwClient db, string tableName)
        {
        ...
        /// <param name="db"></param>
        /// <returns></returns>
        internal static List<KeyValue> GetSchemaList(SqlRcwClient db)
        {
            return new List<KeyValue>();
        }
    }
