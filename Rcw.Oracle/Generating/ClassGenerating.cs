...
namespace Rcw.Oracle
{
    ...
    public class ClassGenerating
    {
        ...
        /// <param name="className"></param>
        /// <returns></returns>
        public string SqlToClass(SqlRcwClient db, string sql, string className)
        {
        ...
        /// <returns></returns>
        public string TableNameToClass(SqlRcwClient db, string tableName)
        {
        ...
        public void CreateClassFiles(SqlRcwClient db, string fileDirectory, string nameSpace = null, bool? tableOrView = null, Action<string> callBack = null, Action<string> preAction = null)
        {
        ...
        public void CreateClassFilesInterface(SqlRcwClient db, bool? tableOrView, Action<DataTable, string, string> callBack)
        {
            var isLog = db.IsEnableLogEvent;
            db.IsEnableLogEvent = false;
            string sql = SqlSugarTool.GetCreateClassSql(tableOrView);
        ...
        ///  创建SQL实体文件,指定表名
        /// </summary>
        public void CreateClassFilesByTableNames(SqlRcwClient db, string fileDirectory, string nameSpace, params string[] tableNames)
        {
            var isLog = db.IsEnableLogEvent;
            db.IsEnableLogEvent = false;
        ...
        /// <param name="db"></param>
        /// <returns></returns>
        public List<string> GetTableNames(SqlRcwClient db)
        {
            var isLog = db.IsEnableLogEvent;
            db.IsEnableLogEvent = false;
            string sql = SqlSugarTool.GetCreateClassSql(null);
        ...
        /// <returns></returns>
        public List<PubModel.DataTableMap> GetTableColumns(SqlRcwClient db, string tableName)
        {
            var isLog = db.IsEnableLogEvent;
            db.IsEnableLogEvent = false;
        ...
        public void ForeachTables(SqlRcwClient db, Action<string> action)
        {
        ...
        /// <param name="tableName"></param>
        /// <returns></returns>
        public string GetTableNameWithSchema(SqlRcwClient db, string tableName)
        {
