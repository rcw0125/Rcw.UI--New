...
namespace Rcw.Oracle
{
    ...
    public static class OracleConfig
    {
        ...
        //}
        internal static void SetParType(string typeName, bool isBinary, string name, OracleParameter par, SqlRcwClient db)
        {
        ...
        internal static void SetParType(string typeName, PropertyInfo prop, OracleParameter par, SqlRcwClient db)
        {
