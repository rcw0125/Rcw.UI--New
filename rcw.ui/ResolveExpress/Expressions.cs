        ...
        private string BinaryExpression(Expression exp)
        {
            ...
            else if (isKeyOperValue)
            {
                ...
                else
                {
                    ...
                    return string.Format(" ({0} {1} " + ParSymbol + "{2}) ", oldLeft.GetTranslationSqlName(), oper, left);
                }
            }
            else if (isValueOperKey)
            {
                ...
                else
                {
                    ...
                    return string.Format("( " + ParSymbol + "{0} {1} {2} )", right, oper, oldRight.GetTranslationSqlName());
                }
            }
